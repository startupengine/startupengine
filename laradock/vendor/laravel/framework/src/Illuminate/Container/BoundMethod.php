...
class BoundMethod
{
    ...
    public static function call(
        ...
        return static::callBoundMethod($container, $callback, function () use (
            $container,
            $callback,
            $parameters
        ) {
    ...
    protected static function getMethodDependencies(
        ...
        foreach (
            static::getCallReflector($callback)->getParameters()
            as $parameter
        ) {
    ...
    protected static function addDependencyForCallParameter(
        ...
        if (array_key_exists($parameter->name, $parameters)) {
            ...
            $parameter->getClass() &&
            array_key_exists($parameter->getClass()->name, $parameters)
        ) {
