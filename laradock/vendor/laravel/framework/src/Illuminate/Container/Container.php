...
class Container implements ArrayAccess, ContainerContract
{
    ...
    {
        return $this->rebinding($abstract, function ($app, $instance) use (
            $target,
            $method
        ) {
    ...
    protected function getContextualConcrete($abstract)
    {
        ...
        foreach ($this->abstractAliases[$abstract] as $alias) {
            if (
                !is_null(($binding = $this->findInContextualBindings($alias)))
            ) {
                return $binding;
            }
        }
    ...
    protected function resolvePrimitive(ReflectionParameter $parameter)
    {
        if (
            !is_null(
                ($concrete = $this->getContextualConcrete(
                    '$' . $parameter->name
                ))
            )
        ) {
    ...
    {
        $message = "Unresolvable dependency resolving [$parameter] in class {$parameter
            ->getDeclaringClass()
            ->getName()}";
