...
class Builder
{
     ...
     * @return $this
     */
    public function addWhereExistsQuery(
        self $query,
        $boolean = 'and',
        $not = false
    ) {
     ...
     * @return $this
     */
    public function whereRowValues(
        $columns,
        $operator,
        $values,
        $boolean = 'and'
    ...
    public function whereJsonContains(
        ...
        if (!$value instanceof Expression) {
            $this->addBinding(
                $this->grammar->prepareBindingForJsonContains($value)
            );
        }
    ...
    protected function runPaginationCountQuery($columns = ['*'])
    {
        ...
        return $this->cloneWithout($without)
            ->cloneWithoutBindings(
                $this->unions ? ['order'] : ['select', 'order']
            )
    ...
    protected function withoutSelectAliases(array $columns)
    {
        return array_map(function ($column) {
            return is_string($column) &&
                ($aliasPosition = stripos($column, ' as ')) !== false
    ...
    {
        $this->bindings = array_merge_recursive(
            $this->bindings,
            $query->bindings
        );
