...
class SqlServerConnector extends Connector implements ConnectorInterface
{
    ...
    protected function getSqlSrvDsn(array $config)
    {
        ...
        if (
            isset($config['multiple_active_result_sets']) &&
            $config['multiple_active_result_sets'] === false
        ) {
            $arguments['MultipleActiveResultSets'] = 'false';
        }

        if (isset($config['transaction_isolation'])) {
            $arguments['TransactionIsolation'] =
                $config['transaction_isolation'];
        }

        if (isset($config['multi_subnet_failover'])) {
            $arguments['MultiSubnetFailover'] =
    ...
    protected function buildConnectString($driver, array $arguments)
    {
        return $driver .
            ...
            implode(
                ';',
                array_map(function ($key) use ($arguments) {
