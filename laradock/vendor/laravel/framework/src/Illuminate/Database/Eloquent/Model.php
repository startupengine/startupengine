    ...
    UrlRoutable
{
    ...
    {
        static::$ignoreOnTouch = array_values(
            array_merge(static::$ignoreOnTouch, $models)
        );
        ...
        try {
            ...
            static::$ignoreOnTouch = array_values(
                array_diff(static::$ignoreOnTouch, $models)
            );
        }
    }
    ...
    public static function isIgnoringTouch($class = null)
    {
        ...
        foreach (static::$ignoreOnTouch as $ignoredClass) {
            if (
                $class === $ignoredClass ||
                is_subclass_of($class, $ignoredClass)
            ) {
                return true;
            }
        }
    ...
    {
        return is_array($ids)
            ? $this->newQueryWithoutScopes()->whereIn(
    ...
    public function refresh()
    {
        ...
        $this->setRawAttributes(
            static::newQueryWithoutScopes()->findOrFail($this->getKey())
                ->attributes
        );
