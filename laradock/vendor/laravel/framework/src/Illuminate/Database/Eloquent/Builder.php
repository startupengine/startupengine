...
class Builder
{
    ...
    public function firstOrCreate(array $attributes, array $values = [])
    {
        ...
        return tap($this->newModelInstance($attributes + $values), function (
            $instance
        ) {
            $instance->save();
        });
    ...
    {
        return tap($this->firstOrNew($attributes), function ($instance) use (
            $values
        ) {
    ...
    public function __get($key)
    {
        ...
        throw new Exception(
            "Property [{$key}] does not exist on the Eloquent builder instance."
        );
    }
