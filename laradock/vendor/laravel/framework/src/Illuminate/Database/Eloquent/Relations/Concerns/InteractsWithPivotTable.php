...
trait InteractsWithPivotTable
{
    ...
    public function toggle($ids, $touch = true)
    {
        ...
        if (
            $touch &&
            (count($changes['attached']) || count($changes['detached']))
        ) {
    ...
    public function updateExistingPivot($id, array $attributes, $touch = true)
    {
        if (
            ...
            return $this->updateExistingPivotUsingCustomClass(
                $id,
                $attributes,
                $touch
            );
     ...
     * @return int
     */
    protected function updateExistingPivotUsingCustomClass(
        $id,
        array $attributes,
        $touch
    ) {
    ...
    protected function formatAttachRecord(
        ...
        [$id, $attributes] = $this->extractAttachIdAndAttributes(
            $key,
            $value,
            $attributes
        );
     ...
     * @return array
     */
    protected function extractAttachIdAndAttributes(
        $key,
        $value,
        array $attributes
    ) {
