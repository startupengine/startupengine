...
class BelongsToMany extends Relation
{
    ...
    protected function buildDictionary(Collection $results)
    {
        ...
        foreach ($results as $result) {
            $dictionary[
                $result->{$this->accessor}->{$this->foreignPivotKey}
            ][] = $result;
        }
    ...
    public function get($columns = ['*'])
    {
        ...
        $models = $builder
            ->addSelect($this->shouldSelect($columns))
            ->getModels();
    ...
    {
        return Str::camel(
            Str::pluralStudly(class_basename($this->getParent()))
        );
    }
    ...
    public function getRelationExistenceQuery(
        ...
        return parent::getRelationExistenceQuery(
            $query,
            $parentQuery,
            $columns
        );
