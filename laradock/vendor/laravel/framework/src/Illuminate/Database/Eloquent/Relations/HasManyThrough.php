...
class HasManyThrough extends Relation
{
    ...
    public function throughParentSoftDeletes()
    {
        return in_array(
            SoftDeletes::class,
            class_uses_recursive($this->throughParent)
        );
    }
    ...
    public function chunkById(
        ...
        return $this->prepareQueryBuilder()->chunkById(
            $count,
            $callback,
            $column,
            $alias
    ...
    public function getRelationExistenceQuery(
        ...
        if (
            $parentQuery->getQuery()->from === $this->throughParent->getTable()
        ) {
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function getRelationExistenceQueryForThroughSelfRelation(
        Builder $query,
        Builder $parentQuery,
        $columns = ['*']
    ) {
        ...
        if ($this->throughParentSoftDeletes()) {
            $query->whereNull(
                $hash . '.' . $this->throughParent->getDeletedAtColumn()
            );
        }
