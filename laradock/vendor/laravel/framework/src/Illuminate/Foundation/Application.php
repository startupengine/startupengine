    ...
    HttpKernelInterface
{
    ...
    public function environment(...$environments)
    {
        if (count($environments) > 0) {
            $patterns = is_array($environments[0])
                ? $environments[0]
                : $environments;
    ...
    public function detectEnvironment(Closure $callback)
    {
        ...
        return $this['env'] = (new EnvironmentDetector())->detect(
            $callback,
            $args
        );
    }
    ...
    public function getProviders($provider)
    {
        ...
        return Arr::where($this->serviceProviders, function ($value) use (
            $name
        ) {
    ...
    public function handle(
        ...
        return $this[HttpKernelContract::class]->handle(
    ...
    {
        return $_ENV['APP_SERVICES_CACHE'] ??
    ...
    {
        return $_ENV['APP_PACKAGES_CACHE'] ??
            $this->bootstrapPath() . '/cache/packages.php';
    }
    ...
    {
        $this->deferredServices = array_merge(
            $this->deferredServices,
            $services
        );
    }
