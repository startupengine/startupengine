...
class NotificationFake implements NotificationFactory, NotificationDispatcher
{
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = collect(
            $this->notificationsFor($notifiable, $notification)
        );

        return $notifications
            ->filter(function ($arguments) use ($callback) {
    ...
    protected function notificationsFor($notifiable, $notification)
    {
        if (
            ...
            return $this->notifications[get_class($notifiable)][
                $notifiable->getKey()
            ][$notification];
        }
