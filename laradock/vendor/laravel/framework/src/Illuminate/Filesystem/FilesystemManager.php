...
class FilesystemManager implements FactoryContract
{
    ...
    {
        return $this->adapt(
            $this->createFlysystem(new FtpAdapter($config), $config)
        );
    }
    ...
    {
        return $this->adapt(
            $this->createFlysystem(new SftpAdapter($config), $config)
        );
    }
        ...
        return $this->adapt(
            $this->createFlysystem(
                new RackspaceAdapter(
                    $this->getRackspaceContainer($client, $config),
                    $root
                ),
                $config
            )
