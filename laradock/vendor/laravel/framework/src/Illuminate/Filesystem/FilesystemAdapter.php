...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
    ...
    {
        if (
            $this->driver->getVisibility($path) ==
    ...
    public function readStream($path)
    {
        try {
            ...
            throw new ContractFileNotFoundException(
                $e->getMessage(),
                $e->getCode(),
                $e
            );
    ...
    public function writeStream($path, $resource, array $options = [])
    {
        try {
            ...
            throw new ContractFileExistsException(
                $e->getMessage(),
                $e->getCode(),
                $e
            );
    ...
    public function temporaryUrl($path, $expiration, array $options = [])
    {
        ...
        if (method_exists($adapter, 'getTemporaryUrl')) {
            ...
            return $this->getAwsTemporaryUrl(
                $adapter,
                $path,
                $expiration,
                $options
            ...
            return $this->getRackspaceTemporaryUrl(
                $adapter,
                $path,
                $expiration,
                $options
     ...
     * @return string
     */
    public function getRackspaceTemporaryUrl(
        $adapter,
        $path,
        $expiration,
        $options
