...
class Worker
{
    ...
    protected function daemonShouldRun(
        ...
        return !(
            ...
            $this->paused ||
            $this->events->until(
                new Events\Looping($connectionName, $queue)
            ) === false
        );
    }
    ...
    protected function markJobAsFailedIfWillExceedMaxAttempts(
        ...
        if (
            $job->timeoutAt() &&
            $job->timeoutAt() <= Carbon::now()->getTimestamp()
        ) {
            $this->failJob($job, $e);
        }
    ...
    protected function raiseBeforeJobEvent($connectionName, $job)
    {
        $this->events->dispatch(
            new Events\JobProcessing($connectionName, $job)
        );
    }
    ...
    {
        $this->events->dispatch(new Events\JobProcessed($connectionName, $job));
    }
    ...
    {
        $this->events->dispatch(
            new Events\JobExceptionOccurred($connectionName, $job, $e)
        );
    }
