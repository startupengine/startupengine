...
class Route
{
    ...
    public function bind(Request $request)
    {
        ...
        $this->parameters = (new RouteParameterBinder($this))->parameters(
            $request
        );
    ...
    {
        foreach (
            $this->parseWhere($name, $expression)
            as $name => $expression
        ) {
    ...
    {
        $this->action['as'] = isset($this->action['as'])
            ? $this->action['as'] . $name
            : $name;
    ...
    public function uses($action)
    {
        $action = is_string($action)
            ? $this->addGroupNamespaceToStringUses($action)
            : $action;
    ...
    public function gatherMiddleware()
    {
        ...
        return $this->computedMiddleware = array_unique(
