...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    public function to($path, $extra = [], $secure = null)
    {
        ...
        $tail = implode(
            '/',
            array_map('rawurlencode', (array) $this->formatParameters($extra))
        );
        ...
        return $this->format($root, '/' . trim($path . '/' . $tail, '/')) .
            $query;
    }
    ...
    public function formatScheme($secure = null)
    {
        ...
        if (is_null($this->cachedScheme)) {
            $this->cachedScheme =
                $this->forceScheme ?: $this->request->getScheme() . '://';
        }
