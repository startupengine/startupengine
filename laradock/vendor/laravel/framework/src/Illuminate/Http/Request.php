...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    public function fullUrl()
    {
        ...
        $question =
            $this->getBaseUrl() . $this->getPathInfo() === '/' ? '/?' : '?';
    ...
    public function fingerprint()
    {
        if (!($route = $this->route())) {
            throw new RuntimeException(
                'Unable to generate fingerprint. Route unavailable.'
            );
        }
    ...
    {
        return Arr::has($this->all() + $this->route()->parameters(), $offset);
    }
