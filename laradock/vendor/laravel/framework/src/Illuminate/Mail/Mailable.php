...
class Mailable implements MailableContract, Renderable
{
    ...
    public function queue(Queue $queue)
    {
        ...
        $connection = property_exists($this, 'connection')
            ? $this->connection
            : null;
    ...
    public function render()
    {
        return $this->withLocale($this->locale, function () {
            ...
            return Container::getInstance()
                ->make('mailer')
                ->render($this->buildView(), $this->buildViewData());
        });
    }
    ...
    public function buildViewData()
    {
        ...
        if (static::$viewDataCallback) {
            $data = array_merge(
                $data,
                call_user_func(static::$viewDataCallback, $this)
            );
        }
    ...
    protected function hasRecipient($address, $name = null, $property = 'to')
    {
        ...
        return collect($this->$property)->contains(function ($actual) use (
            $expected
        ) {
