...
class Markdown
{
    ...
    public function render($view, array $data = [], $inliner = null)
    {
        ...
        $contents = $this->view
            ->replaceNamespace('mail', $this->htmlComponentPaths())
            ->make($view, $data)
            ->render();
        ...
        return new HtmlString(
            ($inliner ?: new CssToInlineStyles())->convert(
                $contents,
                $this->view->make('mail::themes.' . $this->theme)->render()
            )
        );
    }
    ...
    public function renderText($view, array $data = [])
    {
        ...
        $contents = $this->view
            ->replaceNamespace('mail', $this->textComponentPaths())
            ->make($view, $data)
            ->render();
    ...
    {
        return array_unique(
            array_merge($this->componentPaths, [__DIR__ . '/resources/views'])
        );
    }
