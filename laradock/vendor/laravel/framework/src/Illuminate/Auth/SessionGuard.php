...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function basic($field = 'email', $extraConditions = [])
    {
        ...
        if (
            $this->attemptBasic($this->getRequest(), $field, $extraConditions)
        ) {
            return;
        }
    ...
    protected function fireAttemptEvent(array $credentials, $remember = false)
    {
        if (isset($this->events)) {
            $this->events->dispatch(
                new Events\Attempting($this->name, $credentials, $remember)
            );
        }
    }
    ...
    protected function fireLoginEvent($user, $remember = false)
    {
        if (isset($this->events)) {
            $this->events->dispatch(
                new Events\Login($this->name, $user, $remember)
            );
        }
    }
    ...
    protected function fireAuthenticatedEvent($user)
    {
        if (isset($this->events)) {
            $this->events->dispatch(
                new Events\Authenticated($this->name, $user)
            );
        }
    }
    ...
    protected function fireFailedEvent($user, array $credentials)
    {
        if (isset($this->events)) {
            $this->events->dispatch(
                new Events\Failed($this->name, $user, $credentials)
            );
        }
    }
