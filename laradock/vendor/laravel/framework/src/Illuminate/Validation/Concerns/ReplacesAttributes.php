...
trait ReplacesAttributes
{
     ...
     * @return string
     */
    protected function replaceDateFormat(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceDifferent(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceDigitsBetween(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceMimetypes(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceRequiredWith(
        $message,
        $attribute,
        $rule,
        $parameters
    ...
    protected function replaceRequiredWithAll(
        ...
        return $this->replaceRequiredWith(
            $message,
            $attribute,
            $rule,
            $parameters
    ...
    protected function replaceRequiredIf(
        ...
        $parameters[1] = $this->getDisplayableValue(
            $parameters[0],
            Arr::get($this->data, $parameters[0])
        );
    ...
    protected function replaceBefore($message, $attribute, $rule, $parameters)
    {
        ...
        return str_replace(
            ':date',
            $this->getDisplayableValue($attribute, $parameters[0]),
            $message
        );
    }
     ...
     * @return string
     */
    protected function replaceBeforeOrEqual(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceAfterOrEqual(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceDateEquals(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceDimensions(
        $message,
        $attribute,
        $rule,
        $parameters
     ...
     * @return string
     */
    protected function replaceStartsWith(
        $message,
        $attribute,
        $rule,
        $parameters
