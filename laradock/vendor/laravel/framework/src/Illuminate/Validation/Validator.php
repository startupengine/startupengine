...
class Validator implements ValidatorContract
{
    ...
    protected function validateAttribute($attribute, $rule)
    {
        ...
        if (
            ...
            $parameters = $this->replaceAsterisksInParameters(
                $parameters,
                $keys
            );
        }
    ...
    protected function getExplicitKeys($attribute)
    {
        $pattern = str_replace(
            '\*',
            '([^\.]+)',
            preg_quote($this->getPrimaryAttribute($attribute), '/')
        );
     ...
     * @return array
     */
    protected function replaceAsterisksInParameters(
        array $parameters,
        array $keys
    ) {
    ...
    protected function passesOptionalCheck($attribute)
    {
        ...
        $data = ValidationData::initializeAndGatherData(
            $attribute,
            $this->data
        );
    ...
    protected function shouldStopValidating($attribute)
    {
        ...
        return $this->hasRule($attribute, $this->implicitRules) &&
            isset($this->failedRules[$attribute]) &&
            array_intersect(
                array_keys($this->failedRules[$attribute]),
                $this->implicitRules
            );
    }
