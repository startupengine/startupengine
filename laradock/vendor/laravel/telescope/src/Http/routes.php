...
Route::get(
    '/telescope-api/mail/{telescopeEntryId}/preview',
    'MailHtmlController@show'
);
Route::get(
    '/telescope-api/mail/{telescopeEntryId}/download',
...
Route::get(
    '/telescope-api/exceptions/{telescopeEntryId}',
...
Route::get(
    '/telescope-api/notifications/{telescopeEntryId}',
...
Route::get(
    '/telescope-api/queries/{telescopeEntryId}',
    'QueriesController@show'
);
...
Route::get(
    '/telescope-api/requests/{telescopeEntryId}',
...
Route::get(
    '/telescope-api/commands/{telescopeEntryId}',
...
Route::get(
    '/telescope-api/schedule/{telescopeEntryId}',
...
Route::post(
    '/telescope-api/monitored-tags/delete',
    'MonitoredTagController@destroy'
);
