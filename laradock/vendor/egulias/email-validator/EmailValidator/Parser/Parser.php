...
abstract class Parser
{
    ...
    protected function validateQuotedPair()
    {
        ...
        $this->warnings[QuotedPart::CODE] = new QuotedPart(
            $this->lexer->getPrevious()['type'],
    ...
    protected function parseComments()
    {
        ...
        $this->lexer->moveNext();
        if (
            $this->lexer->isNextTokenAny(array(
                EmailLexer::GENERIC,
                EmailLexer::S_EMPTY
            ))
        ) {
    ...
    protected function parseFWS()
    {
        ...
        if (
            ...
            $this->lexer->token['type'] === EmailLexer::C_NUL
        ) {
    ...
    protected function checkDQUOTE($hasClosingQuote)
    {
        ...
        if (
            $this->lexer->isNextToken(EmailLexer::GENERIC) &&
            $previous['type'] === EmailLexer::GENERIC
        ) {
            throw new ExpectingATEXT();
        }
        ...
        $this->warnings[QuotedString::CODE] = new QuotedString(
            $previous['value'],
