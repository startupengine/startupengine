...
class SessionHandlerProxyTest extends TestCase
{
    ...
    {
        $this->mock->expects($this->once())->method('destroy');
    ...
    {
        $this->mock->expects($this->once())->method('gc');
    ...
    public function testValidateId()
    {
        ...
        $mock->expects($this->once())->method('validateId');
    ...
    public function testUpdateTimestamp()
    {
        ...
        $mock->expects($this->once())->method('updateTimestamp');
