...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    public function testSetContentDispositionGeneratesSafeFallbackFilenameForWronglyEncodedFilename()
    {
        ...
        $this->assertSame(
            'attachment; filename=f__.html; filename*=utf-8\'\'f%F6%F6.html',
            $response->headers->get('Content-Disposition')
        );
    }
    ...
    public function testRequests(
        ...
        $response = BinaryFileResponse::create(
            __DIR__ . '/File/Fixtures/test.gif',
            200,
     ...
     * @dataProvider provideRanges
     */
    public function testRequestsWithoutEtag(
        $requestRange,
        $offset,
        $length,
        $responseRange
    ...
    public function testRangeRequestsWithoutLastModifiedDate()
    {
        ...
        $this->expectOutputString(
            file_get_contents(__DIR__ . '/File/Fixtures/test.gif')
        );
        $response = clone $response;
        $response->prepare($request);
        $response->sendContent();
    ...
    public function testXSendfile($file)
    {
        ...
        $response = BinaryFileResponse::create($file, 200, [
            'Content-Type' => 'application/octet-stream'
        ]);
        $response->prepare($request);
        ...
        $this->assertContains(
            'README.md',
            $response->headers->get('X-Sendfile')
        );
    }
    ...
    {
        return new BinaryFileResponse(__DIR__ . '/../README.md', 200, [
            'Content-Type' => 'application/octet-stream'
        ]);
    }
