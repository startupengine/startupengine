...
class RequestTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $request = Request::create('http://test.com/foo?bar=foo', 'GET', [
            'bar' => 'baz'
        ]);
        $this->assertEquals('http://test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
    ...
    public function testGetFormatFromMimeTypeWithParameters()
    {
        ...
        $this->assertEquals(
            'json',
            $request->getFormat('application/json; charset=utf-8')
        );
        $this->assertEquals(
            'json',
            $request->getFormat('application/json;charset=utf-8')
    ...
    public function testGetFormatWithCustomMimeType()
    {
        ...
        $this->assertEquals(
            'custom',
            $request->getFormat('application/vnd.foo.api;myversion=2.3')
        );
    }
    ...
    public function testGetUri()
    {
        ...
        $this->assertEquals(
            'http://host/index.php/path/info?query=string',
            $request->getUri(),
        ...
        $this->assertEquals(
            'http://servername/index.php/path/info?query=string',
            $request->getUri(),
        ...
        $this->assertEquals(
            'http://servername/path/info?query=string',
            $request->getUri(),
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals(
            'http://servername/index.php/some/path',
            $request->getUriForPath('/some/path'),
    ...
    public function getQueryStringNormalizationData()
    {
        return [
            ...
            [
                'foo[]=Z&foo[]=A',
                'foo%5B0%5D=Z&foo%5B1%5D=A',
                'keeps order of values'
            ],
            [
                'foo[Z]=B&foo[A]=B',
                'foo%5BZ%5D=B&foo%5BA%5D=B',
                'keeps order of keys'
            ],
    ...
    public function testGetHost()
    {
        ...
        $request->initialize(
            ...
            [],
            [],
            ['SERVER_NAME' => 'www.example.com', 'HTTP_HOST' => 'www.host.com']
        );
        $this->assertEquals(
            'www.host.com',
            $request->getHost(),
    ...
    public function testGetSetMethod()
    {
        ...
        $this->assertFalse(
            ...
            'httpMethodParameterOverride should be disabled by default'
        );
        ...
        $this->assertTrue(
            Request::getHttpMethodParameterOverride(),
            'httpMethodParameterOverride should be enabled now but it is not'
        );
        ...
        $this->assertSame(
            'POST',
            $request->getMethod(),
            '->getMethod() returns the request method if invalid type is defined in query'
        );
    }
    ...
    public function testGetClientIp(
        ...
        $request = $this->getRequestInstanceForClientIpTests(
            $remoteAddr,
            $httpForwardedFor,
            $trustedProxies
        );
    ...
    public function testGetClientIpsForwarded(
        ...
        $request = $this->getRequestInstanceForClientIpsForwardedTests(
            $remoteAddr,
            $httpForwarded,
            $trustedProxies
        );
    ...
    public function getClientIpsForwardedProvider()
    {
        ...
        return [
            ...
            [
                ['2620:0:1cfe:face:b00c::3', '192.0.2.43'],
                '::1',
    ...
    public function getClientIpsProvider()
    {
        ...
        return [
            ...
            [
                ...
                '123.45.67.89',
                '127.0.0.1, 87.65.43.21, 88.88.88.88',
                ['123.45.67.89', '87.65.43.21', '88.88.88.88', '127.0.0.1']
            ],

            // multiple forwarded for with remote IPv6 addr trusted
            [
                ['2620:0:1cfe:face:b00c::3', '3620:0:1cfe:face:b00c::3'],
                '1620:0:1cfe:face:b00c::3',
            ...
            [
                ...
                '1620:0:1cfe:face:b00c::3',
                '3620:0:1cfe:face:b00c::3,2620:0:1cfe:face:b00c::3',
                ['1620:0:1cfe:face:b00c::3', '2620:0:1cfe:face:b00c::3']
            ],
            // multiple forwarded for with remote IPv4 addr and some reverse proxies trusted but in the middle
            [
                ['2620:0:1cfe:face:b00c::3', '4620:0:1cfe:face:b00c::3'],
                '1620:0:1cfe:face:b00c::3',
                '4620:0:1cfe:face:b00c::3,3620:0:1cfe:face:b00c::3,2620:0:1cfe:face:b00c::3',
                ['1620:0:1cfe:face:b00c::3', '3620:0:1cfe:face:b00c::3']
            ],
    ...
    public function testGetClientIpsWithConflictingHeaders(
        ...
        Request::setTrustedProxies(
            ['88.88.88.88'],
            Request::HEADER_X_FORWARDED_ALL | Request::HEADER_FORWARDED
        );
    ...
    public function testGetClientIpsOnlyXHttpForwardedForTrusted(
        ...
        $this->assertSame(
            array_reverse(explode(',', $httpXForwardedFor)),
            $request->getClientIps()
        );
    }
    ...
    public function testContentAsResource()
    {
        ...
        $this->assertEquals(
            'My other content',
            stream_get_contents($req->getContent(true))
        );
    ...
    {
        return [['PUT'], ['DELETE'], ['PATCH'], ['put'], ['delete'], ['patch']];
    }
    ...
    public function testGetPreferredLanguage()
    {
        ...
        $this->assertEquals(
            'fr-ch',
            $request->getPreferredLanguage(['fr-ch', 'fr-fr'])
        );
        ...
        $this->assertEquals(
            'en',
            $request->getPreferredLanguage(['en', 'en-us'])
        );
    ...
    private function getRequestInstanceForClientIpTests(
        $remoteAddr,
        $httpForwardedFor,
        $trustedProxies
    ) {
    ...
    private function getRequestInstanceForClientIpsForwardedTests(
        $remoteAddr,
        $httpForwarded,
        $trustedProxies
    ) {
    ...
    {
        Request::setTrustedHosts([
            'localhost(\.local){0,1}#,example.com',
            'localhost'
        ]);
    ...
    {
        return [['a' . str_repeat('.a', 40000)], [str_repeat(':', 101)]];
    }
    ...
    public function protocolVersionProvider()
    {
        return [
            ...
            'trusted with via and protocol name' => [
                'HTTP/2.0',
                true,
                'HTTP/1.0 fred, HTTP/1.1 nowhere.com (Apache/1.1)',
                'HTTP/1.0'
            ],
            'trusted with broken via' => [
                'HTTP/2.0',
                true,
                'HTTP/1^0 foo',
                'HTTP/2.0'
            ],
            'trusted with partially-broken via' => [
                'HTTP/2.0',
                true,
                '1.0 fred, foo',
                'HTTP/1.0'
    ...
    public function nonstandardRequestsData()
    {
        return [
            ...
            [
                ...
                '',
                '/x',
                'http://host:8080/hello/app.php/x',
                '/hello',
                '/hello/app.php'
            ],
            [
            ...
            [
                ...
                'a=b',
                '/x',
                'http://host:8080/hello/app.php/x?a=b',
                '/hello',
                '/hello/app.php'
            ],
            [
