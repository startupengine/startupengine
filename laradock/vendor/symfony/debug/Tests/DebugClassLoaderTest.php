...
class DebugClassLoaderTest extends TestCase
{
    ...
    {
        $this->assertTrue(
            class_exists(__NAMESPACE__ . '\Fixtures\NotPSR0', true)
        );
    }
    ...
    {
        $this->assertTrue(
            class_exists(__NAMESPACE__ . '\Fixtures\NotPSR0bis', true)
        );
    }
    ...
    {
        $this->assertTrue(
            class_exists(__NAMESPACE__ . '\Fixtures\ClassAlias', true)
        );
    }
    ...
    public function testDeprecatedSuper($class, $super, $type)
    {
        ...
        $xError = [
            ...
            'message' =>
                'The "Test\Symfony\Component\Debug\Tests\\' .
                    $class .
                    '" class ' .
                    $type .
                    ' "Symfony\Component\Debug\Tests\Fixtures\\' .
                    $super .
                    '" that is deprecated but this is a test deprecation notice.'
        ];
    ...
    public function testInterfaceExtendsDeprecatedInterface()
    {
        ...
        class_exists(
            'Test\\' . __NAMESPACE__ . '\\NonDeprecatedInterfaceClass',
            true
        );
    ...
    public function testDeprecatedSuperInSameNamespace()
    {
        ...
        class_exists(
            'Symfony\Bridge\Debug\Tests\Fixtures\ExtendsDeprecatedParent',
            true
        );
    ...
    public function testExtendedFinalClass()
    {
        ...
        while (
            class_exists(
                ($finalClass = __NAMESPACE__ . '\\Fixtures\\FinalClass' . $i++),
                false
            )
        ) {
            ...
            class_exists(
                'Test\\' .
                    __NAMESPACE__ .
                    '\\Extends' .
                    substr($finalClass, strrpos($finalClass, '\\') + 1),
                true
            );
        }
    ...
    public function testExtendedDeprecatedMethodDoesntTriggerAnyNotice()
    {
        ...
        class_exists(
            'Test\\' . __NAMESPACE__ . '\\ExtendsAnnotatedClass',
            true
        );
    ...
    public function testExtendedMethodDefinesNewParameters()
    {
        ...
        class_exists(
            __NAMESPACE__ . '\\Fixtures\SubClassWithAnnotatedParameters',
            true
        );
    ...
    public function testUseTraitWithInternalMethod()
    {
        ...
        class_exists(
            'Test\\' . __NAMESPACE__ . '\\UseTraitWithInternalMethod',
            true
        );
    ...
    public function testEvaluatedCode()
    {
        $this->assertTrue(
            class_exists(
                __NAMESPACE__ . '\Fixtures\DefinitionInEvaluatedCode',
                true
            )
        );
    }
...
class ClassLoader
{
    ...
    {
        return [
            __NAMESPACE__ . '\Fixtures\NotPSR0bis' =>
                __DIR__ . '/Fixtures/notPsr0Bis.php'
        ];
    }
    ...
    public function findFile($class)
    {
        ...
        if (__NAMESPACE__ . '\TestingUnsilencing' === $class) {
            ...
            eval(
                'namespace ' .
                    __NAMESPACE__ .
                    '; class TestingStacking { function foo() {} }'
            );
            ...
            eval(
                'namespace Symfony\Bridge\Debug\Tests\Fixtures; class ExtendsDeprecatedParent extends \\' .
                    __NAMESPACE__ .
                    '\Fixtures\DeprecatedClass {}'
            );
        } elseif (
            'Test\\' . __NAMESPACE__ . '\DeprecatedParentClass' ===
            $class
        ) {
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class DeprecatedParentClass extends \\' .
                    __NAMESPACE__ .
                    '\Fixtures\DeprecatedClass {}'
            );
        } elseif (
            'Test\\' . __NAMESPACE__ . '\DeprecatedInterfaceClass' ===
            $class
        ) {
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class DeprecatedInterfaceClass implements \\' .
                    __NAMESPACE__ .
                    '\Fixtures\DeprecatedInterface {}'
            );
        } elseif (
            'Test\\' . __NAMESPACE__ . '\NonDeprecatedInterfaceClass' ===
            $class
            ...
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class NonDeprecatedInterfaceClass implements \\' .
                    __NAMESPACE__ .
                    '\Fixtures\NonDeprecatedInterface {}'
            );
        } elseif ('Test\\' . __NAMESPACE__ . '\Float' === $class) {
            eval('namespace Test\\' . __NAMESPACE__ . '; class Float {}');
        } elseif (
            0 ===
            strpos($class, 'Test\\' . __NAMESPACE__ . '\ExtendsFinalClass')
        ) {
            ...
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class ExtendsAnnotatedClass extends \\' .
                    __NAMESPACE__ .
                    '\Fixtures\AnnotatedClass {
            ...
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class ExtendsInternals extends ExtendsInternalsParent {
                use \\' .
                    __NAMESPACE__ .
                    '\Fixtures\InternalTrait;

                public function internalMethod() { }
            }'
            );
        } elseif (
            'Test\\' . __NAMESPACE__ . '\ExtendsInternalsParent' ===
            $class
        ) {
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class ExtendsInternalsParent extends \\' .
                    __NAMESPACE__ .
                    '\Fixtures\InternalClass implements \\' .
                    __NAMESPACE__ .
                    '\Fixtures\InternalInterface { }'
            );
        } elseif (
            'Test\\' . __NAMESPACE__ . '\UseTraitWithInternalMethod' ===
            $class
            ...
            eval(
                'namespace Test\\' .
                    __NAMESPACE__ .
                    '; class UseTraitWithInternalMethod { use \\' .
                    __NAMESPACE__ .
                    '\Fixtures\TraitWithInternalMethod; }'
            );
        }
    }
}
