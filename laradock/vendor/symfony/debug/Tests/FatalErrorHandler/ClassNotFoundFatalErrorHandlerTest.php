...
class ClassNotFoundFatalErrorHandlerTest extends TestCase
{
    public static function setUpBeforeClass()
    {
        foreach (spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof ComposerClassLoader) {
                $function[0]->add(
                    'Symfony_Component_Debug_Tests_Fixtures',
     ...
     */
    public function testHandleClassNotFound(
        $error,
        $translatedMessage,
        $autoloader = null
    ) {
        ...
        return [
            ...
            [
                [
                    ...
                    'file' => 'foo.php',
                    'message' =>
                        'Class \'UndefinedFunctionException\' not found'
                ],
            ...
            [
                [
                    ...
                    'file' => 'foo.php',
                    'message' =>
                        'Class \'Foo\\Bar\\UndefinedFunctionException\' not found'
                ],
