...
class CliDescriptorTest extends TestCase
{
    ...
    public function testDescribe(array $context, string $expectedOutput)
    {
        ...
        $descriptor = new CliDescriptor(
            new CliDumper(function ($s) {
                return $s;
            })
        );
        ...
        $descriptor->describe(
            $output,
            new Data([[123]]),
            $context + ['timestamp' => 1544804268.3668],
            1
        );
        ...
        yield 'source' => [
            [
                'source' => [
                    ...
                    'line' => 30,
                    'file' =>
                        '/Users/ogi/symfony/src/Symfony/Component/VarDumper/Tests/Command/Descriptor/CliDescriptorTest.php'
                ]
            ],
            <<<TXT
