...
class AmqpCaster
{
    ...
    public static function castConnection(
        \AMQPConnection $c,
        array $a,
        Stub $stub,
        $isNested
    ...
    public static function castChannel(
        \AMQPChannel $c,
        array $a,
        Stub $stub,
        $isNested
    ...
    public static function castQueue(
        \AMQPQueue $c,
        array $a,
        Stub $stub,
        $isNested
    ...
    public static function castExchange(
        \AMQPExchange $c,
        array $a,
        Stub $stub,
        $isNested
        ...
        $type = isset(self::$exchangeTypes[$c->getType()])
            ? new ConstStub(self::$exchangeTypes[$c->getType()], $c->getType())
            : $c->getType();
    ...
    public static function castEnvelope(
        \AMQPEnvelope $c,
        array $a,
        Stub $stub,
        $isNested,
