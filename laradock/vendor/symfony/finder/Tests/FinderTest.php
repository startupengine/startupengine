...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testName()
    {
        ...
        $finder->name('test.py');
        $this->assertIterator(
            $this->toAbsolute(['test.php', 'test.py']),
            $finder->in(self::$tmpDir)->getIterator()
        );
    ...
    public function testNotName()
    {
        ...
        $finder->notName('*.py');
        $this->assertIterator(
            $this->toAbsolute(['foo', 'foo/bar.tmp', 'toto', 'foo bar', 'qux']),
            $finder->in(self::$tmpDir)->getIterator()
        );
    ...
    public function testRegexName($regex)
    {
        ...
        $finder->name($regex);
        $this->assertIterator(
            $this->toAbsolute(['test.py', 'test.php']),
            $finder->in(self::$tmpDir)->getIterator()
        );
    }
    ...
    public function testDate()
    {
        ...
        $this->assertIterator(
            $this->toAbsolute(['foo/bar.tmp', 'test.php']),
            $finder->in(self::$tmpDir)->getIterator()
        );
    }
    ...
    public function testDateWithArrayParam()
    {
        ...
        $this->assertSame(
            $finder,
            $finder->files()->date(['>= 2005-10-15', 'until last month'])
        );
        $this->assertIterator(
            $this->toAbsolute(['foo/bar.tmp', 'test.php']),
            $finder->in(self::$tmpDir)->getIterator()
    ...
    public function testIgnoreVCS()
    {
        ...
        $this->assertSame(
            $finder,
            $finder->ignoreVCS(true)->ignoreDotFiles(false)
        );
        $this->assertIterator(
            $this->toAbsolute([
                'foo',
    ...
    public function testIgnoreDotFiles()
    {
        ...
        $this->assertSame(
            $finder,
            $finder->ignoreDotFiles(false)->ignoreVCS(false)
        );
        $this->assertIterator(
            $this->toAbsolute([
                '.git',
    ...
    public function testReverseSorting()
    {
        ...
        $this->assertOrderedIteratorInForeach(
            $this->toAbsolute([
                'toto',
                'test.py',
                'test.php',
    ...
    public function testFilter()
    {
        ...
        $this->assertSame(
            $finder,
            $finder->filter(function (\SplFileInfo $f) {
    ...
    public function testInWithGlob()
    {
        $finder = $this->buildFinder();
        $finder
            ->in([__DIR__ . '/Fixtures/*/B/C/', __DIR__ . '/Fixtures/*/*/B/C/'])
            ->getIterator();

        $this->assertIterator(
            $this->toAbsoluteFixtures([
                'A/B/C/abc.dat',
    ...
    public function testGetIterator()
    {
        ...
        $this->assertEquals(
            3,
            iterator_count($finder->directories()->in(self::$tmpDir)),
            'implements the \IteratorAggregate interface'
        );
    ...
    public function testAppendWithAFinder()
    {
        ...
        $this->assertIterator(
            $this->toAbsolute(['foo', 'foo/bar.tmp', 'qux', 'toto']),
            $finder->getIterator()
        );
    }
    ...
    public function testAppendWithAnArray()
    {
        ...
        $this->assertIterator(
            $this->toAbsolute(['foo', 'foo/bar.tmp', 'toto']),
            $finder->getIterator()
        );
    }
    ...
    {
        $locations = [self::$tmpDir . '/', self::$tmpDir . '/toto/'];
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === ($couldRead = is_readable($testDir))) {
            try {
                $this->assertIterator(
                    $this->toAbsolute(['foo bar', 'test.php', 'test.py']),
                    $finder->getIterator()
                );
                $this->fail(
                ...
                if (
                    $e instanceof \PHPUnit\Framework\ExpectationFailedException
                ) {
                    $this->fail(
                        sprintf(
                            "Expected exception:\n%s\nGot:\n%s\nWith comparison failure:\n%s",
