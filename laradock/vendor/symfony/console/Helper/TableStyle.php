...
class TableStyle
{
    ...
    public function setHorizontalBorderChar($horizontalBorderChar)
    {
        ...
        return $this->setHorizontalBorderChars(
    ...
    public function getHorizontalBorderChar()
    {
        @trigger_error(
            sprintf(
                'The "%s()" method is deprecated since Symfony 4.1, use getBorderChars() instead.',
                __METHOD__
            ),
            E_USER_DEPRECATED
        );
    ...
    public function setVerticalBorderChar($verticalBorderChar)
    {
        ...
        return $this->setVerticalBorderChars(
            $verticalBorderChar,
            $verticalBorderChar
        );
    }
    ...
    public function setCrossingChar($crossingChar)
    {
        @trigger_error(
            sprintf(
                'The "%s()" method is deprecated since Symfony 4.1. Use setDefaultCrossingChar() instead.',
                __METHOD__
            ),
            E_USER_DEPRECATED
        );
