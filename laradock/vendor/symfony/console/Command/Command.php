...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output)
    {
        ...
        if (
            ...
            null === $input->getArgument('command')
        ) {
    ...
    public function getProcessedHelp()
    {
        $name = $this->name;
        $isSingleCommand =
            $this->application && $this->application->isSingleCommand();
        ...
        return str_replace(
            $placeholders,
            $replacements,
            $this->getHelp() ?: $this->getDescription()
        );
    }
    ...
    public function getSynopsis($short = false)
    {
        ...
        if (!isset($this->synopsis[$key])) {
            $this->synopsis[$key] = trim(
                sprintf(
                    '%s %s',
                    $this->name,
                    $this->definition->getSynopsis($short)
                )
            );
        }
