...
class SymfonyStyleTest extends TestCase
{
     ...
     */
    public function testInteractiveOutputs(
        $inputCommandFilepath,
        $outputFilepath
    ) {
        $code = require $inputCommandFilepath;
        $this->command->setCode($code);
    ...
    public function inputInteractiveCommandToOutputFilesProvider()
    {
        ...
        return array_map(
            null,
            glob($baseDir . '/command/interactive_command_*.php'),
    ...
    public function inputCommandToOutputFilesProvider()
    {
        ...
        return array_map(
            ...
            glob($baseDir . '/output/output_*.txt')
        );
    }
    ...
    public function testGetErrorStyle()
    {
        ...
        $errorOutput->method('getFormatter')->willReturn(new OutputFormatter());
