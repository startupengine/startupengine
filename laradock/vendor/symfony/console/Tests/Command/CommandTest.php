...
class CommandTest extends TestCase
{
    ...
    public function testGetSetHelp()
    {
        ...
        $this->assertEquals(
            '',
            $command->getHelp(),
            '->getHelp() does not fall back to the description'
        );
    }
    ...
    public function testGetProcessedHelp()
    {
        ...
        $this->assertContains(
            'description',
            $command->getProcessedHelp(),
            '->getProcessedHelp() falls back to the description'
        );
        ...
        $this->assertContains(
            'The namespace:name command does...',
            $command->getProcessedHelp(),
            '->getProcessedHelp() replaces %command.name% correctly in single command applications'
        );
        $this->assertNotContains(
            '%command.full_name%',
            $command->getProcessedHelp(),
            '->getProcessedHelp() replaces %command.full_name% in single command applications'
        );
    }
    ...
    public function testGetHelper()
    {
        ...
        $this->assertEquals(
            ...
            $command->getHelper('formatter')->getName(),
    ...
    public function testMergeApplicationDefinition()
    {
        ...
        $application1
            ->getDefinition()
            ->addArguments([new InputArgument('foo')]);
    ...
    public function testRunInteractive()
    {
        ...
        $this->assertEquals(
            'interact called' . PHP_EOL . 'execute called' . PHP_EOL,
            $tester->getDisplay(),
    ...
    public function testRunReturnsIntegerExitCode()
    {
        ...
        $command = $this->getMockBuilder('TestCommand')
            ->setMethods(['execute'])
            ->getMock();
        $command
            ->expects($this->once())
    ...
    public function testSetCode()
    {
        ...
        $tester->execute([]);
        $this->assertEquals(
            'interact called' . PHP_EOL . 'from the code...' . PHP_EOL,
            $tester->getDisplay()
        );
    }
    ...
    public function testSetCodeBindToClosure($previouslyBound, $expected)
    {
        ...
        $tester->execute([]);
        $this->assertEquals(
            'interact called' . PHP_EOL . $expected . PHP_EOL,
            $tester->getDisplay()
        );
    }
    ...
    public function testSetCodeWithStaticClosure()
    {
        ...
        $this->assertEquals(
            'interact called' . PHP_EOL . 'bound' . PHP_EOL,
            $tester->getDisplay()
        );
    }
    ...
    public function callableMethodCommand(
        InputInterface $input,
        OutputInterface $output
    ) {
        $output->writeln('from the code...');
