...
class ArrayInputTest extends TestCase
{
    ...
    public function testHasParameterOption()
    {
        ...
        $this->assertFalse(
            $input->hasParameterOption('--bar', true),
    ...
    public function testGetParameterOption()
    {
        ...
        $this->assertEquals(
            'bar',
            $input->getParameterOption('--foo'),
            '->getParameterOption() returns the option of specified name'
        );
        $this->assertEquals(
            'default',
            $input->getParameterOption('--bar', 'default'),
    ...
    public function testToString()
    {
        ...
        $this->assertSame(
            '-b=bval_1 -b=bval_2 --f=fval_1 --f=fval_2',
            (string) $input
        );
