...
class InputDefinitionTest extends TestCase
{
    ...
    public function testArrayArgumentHasToBeLast()
    {
        ...
        $definition->addArgument(
            new InputArgument('fooarray', InputArgument::IS_ARRAY)
        );
    ...
    public function testGetArgumentRequiredCount()
    {
        ...
        $this->assertEquals(
            1,
            $definition->getArgumentRequiredCount(),
    ...
    public function testGetOptionForMultiShortcut()
    {
        ...
        $this->assertEquals(
            $this->multi,
            $definition->getOptionForShortcut('mmm'),
            '->getOptionForShortcut() returns a InputOption by its shortcut'
        );
    }
    ...
    public function testGetSynopsis(
        ...
        $this->assertEquals(
            $expectedSynopsis,
            $definition->getSynopsis(),
            $message ? '->getSynopsis() ' . $message : ''
        );
    }
    ...
    public function getGetSynopsisData()
    {
        return [
            ...
            [
                new InputDefinition([new InputArgument('foo')]),
                '[<foo>]',
            ...
            [
                ...
                '[<foo> [<bar>]]',
                'chains optional arguments inside brackets'
            ],
            [
                new InputDefinition([
            ...
            [
                ...
                '<foo>...',
                'uses an ellipsis for required array arguments'
            ],
