...
abstract class AbstractDescriptorTest extends TestCase
{
    ...
    {
        return $this->getDescriptionTestData(
            ObjectsProvider::getInputArguments()
        );
    }
    ...
    {
        return $this->getDescriptionTestData(
            ObjectsProvider::getInputOptions()
        );
    }
    ...
    {
        return $this->getDescriptionTestData(
            ObjectsProvider::getInputDefinitions()
        );
    }
    ...
    protected function assertDescription(
        $expectedDescription,
        $describedObject,
        array $options = []
    ) {
        $output = new BufferedOutput(BufferedOutput::VERBOSITY_NORMAL, true);
        $this->getDescriptor()->describe(
            $output,
            $describedObject,
            $options + ['raw_output' => true]
        );
        $this->assertEquals(
            trim($expectedDescription),
