...
class ProgressBarTest extends TestCase
{
    ...
    public function testOverwriteWithSectionOutput()
    {
        ...
        $output = new ConsoleSectionOutput(
            $stream->getStream(),
            $sections,
            $stream->getVerbosity(),
            $stream->isDecorated(),
    ...
    public function testOverwriteMultipleProgressBarsWithSectionOutputs()
    {
        $sections = [];
        $stream = $this->getOutputStream(true);
        $output1 = new ConsoleSectionOutput(
            $stream->getStream(),
            $sections,
            $stream->getVerbosity(),
            $stream->isDecorated(),
        ...
        $output2 = new ConsoleSectionOutput(
            $stream->getStream(),
            $sections,
            $stream->getVerbosity(),
            $stream->isDecorated(),
    ...
    public function testMultipleSectionsWithCustomFormat()
    {
        ...
        ProgressBar::setFormatDefinition(
            'test',
            '%current%/%max% [%bar%] %percent:3s%% Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.'
        );
        ...
        $this->assertEquals(
            '  0/50 [>---------------------------]   0%' .
                ...
                PHP_EOL .
                "\x1b[3A\x1b[0J" .
                ' 1/50 [>]   2% Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.' .
                PHP_EOL,
            stream_get_contents($stream->getStream())
        );
    }
    ...
    protected function generateOutput($expected)
    {
        ...
        return "\x0D\x1B[2K" .
            ($count ? str_repeat("\x1B[1A\x1B[2K", $count) : '') .
            $expected;
    }
