...
class TableTest extends TestCase
{
     ...
     * @dataProvider renderProvider
     */
    public function testRenderAddRows(
        $headers,
        $rows,
        $style,
        $expected,
     ...
     * @dataProvider renderProvider
     */
    public function testRenderAddRowsOneByOne(
        $headers,
        $rows,
        $style,
        $expected,
...
TABLE
            ...
            'Cell with colspan' => [
                ...
                [
                    ...
                    new TableSeparator(),
                    [
                        new TableCell('Divine Comedy(Dante Alighieri)', [
                            'colspan' => 3
                        ])
                    ],
                    new TableSeparator(),
                    [
                        new TableCell('Arduino: A Quick-Start Guide', [
                            'colspan' => 2
                        ]),
                        'Mark Schmidt'
                    ],
...
TABLE;
    ...
    {
        $table = new Table(($output = $this->getOutputStream()));
        $table->setRows([[new TableCell('foo', ['colspan' => 2])]]);
        $table->render();
        $table->render();
        $table->render();
...
TABLE;
    ...
    public function testThrowsWhenTheCellInAnArray()
    {
        ...
        $table
            ->setHeaders(['ISBN', 'Title', 'Author', 'Price'])
            ->setRows([['99921-58-10-7', [], 'Dante Alighieri', '9.95']]);
