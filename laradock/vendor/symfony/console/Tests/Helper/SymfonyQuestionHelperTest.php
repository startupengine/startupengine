...
class SymfonyQuestionHelperTest extends AbstractQuestionHelperTest
{
    public function testAskChoice()
    {
        ...
        $this->assertOutputContains(
            'What is your favorite superhero? [Spiderman]',
            $output
        );
        ...
        $this->assertOutputContains(
            'Input "Fabien" is not a superhero!',
            $output
        );
        ...
        $this->assertOutputContains(
            'What is your favorite superhero? [Superman, Batman]',
            $output
        );
    ...
    public function testAskChoiceWithChoiceValueAsDefault()
    {
        ...
        $this->assertOutputContains(
            'What is your favorite superhero? [Batman]',
            $output
        );
    }
    ...
    public function testAskReturnsNullIfValidatorAllowsIt()
    {
        ...
        $input = $this->createStreamableInputInterfaceMock(
            $this->getInputStream("\n")
        );
        $this->assertNull(
            $questionHelper->ask(
    ...
    public function testAskEscapeDefaultValue()
    {
        ...
        $helper->ask(
            $input,
            ($output = $this->createOutputInterface()),
            new Question('Can I have a backslash?', '\\')
        );
    ...
    public function testAskEscapeAndFormatLabel()
    {
        $helper = new SymfonyQuestionHelper();
        $input = $this->createStreamableInputInterfaceMock(
            $this->getInputStream('Foo\\Bar')
        );
        $helper->ask(
            $input,
            ($output = $this->createOutputInterface()),
            new Question(
                'Do you want to use Foo\\Bar <comment>or</comment> Foo\\Baz\\?',
                'Foo\\Baz'
            )
        );

        $this->assertOutputContains(
            'Do you want to use Foo\\Bar or Foo\\Baz\\? [Foo\\Baz]:',
            $output
        );
    }
    ...
    public function testLabelTrailingBackslash()
    {
        $helper = new SymfonyQuestionHelper();
        $input = $this->createStreamableInputInterfaceMock(
            $this->getInputStream('sure')
        );
        $helper->ask(
            $input,
            ($output = $this->createOutputInterface()),
            new Question('Question with a trailing \\')
        );
