...
class TranslatorTest extends TestCase
{
    ...
    public function testNestedFallbackCatalogueWhenUsingMultipleLocales()
    {
        ...
        $this->assertNotNull(
            $translator->getCatalogue('ru')->getFallbackCatalogue()
        );
    }
    ...
    public function testFallbackCatalogueResources()
    {
        ...
        $translator->addResource(
            'yml',
            __DIR__ . '/fixtures/resources.yml',
            'en'
        );
    ...
    public function testTransValidLocale($locale)
    {
        ...
        $this->assertEquals(
            'OK',
            $translator->trans('test', [], null, $locale)
        );
    }
    ...
    public function getTransChoiceTests()
    {
        return [
            ...
            [
                ...
                'one: Il y a %count% pomme|more: Il y a quelques pommes',
                2,
                ['%count%' => 'quelques'],
                'fr',
                ''
    ...
    public function testIntlFormattedDomain()
    {
        ...
        $translator->addResource(
            'array',
            ['some_message' => 'Hello %name%'],
            'en'
        );
        $this->assertSame(
            'Hello Bob',
            $translator->trans('some_message', ['%name%' => 'Bob'])
        );
