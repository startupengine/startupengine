...
class FileLinkFormatterTest extends TestCase
{
    public function testWhenNoFileLinkFormatAndNoRequest()
    {
        ...
        $this->assertFalse(
            $sut->format('/kernel/root/src/my/very/best/file.php', 3)
        );
    }
    ...
    public function testWhenFileLinkFormatAndNoRequest()
    {
        ...
        $sut = new FileLinkFormatter(
            'debug://open?url=file://%f&line=%l',
            new RequestStack()
        );

        $this->assertSame(
            "debug://open?url=file://$file&line=3",
            $sut->format($file, 3)
        );
    }
    ...
    public function testWhenNoFileLinkFormatAndRequest()
    {
        ...
        $this->assertSame(
            'http://www.example.org/_profiler/open?file=file.php&line=3#line3',
            $sut->format($file, 3)
        );
    }
}
