...
class SubRequestHandlerTest extends TestCase
{
    ...
    public function testTrustedHeadersAreKept()
    {
        ...
        $kernel = new TestSubRequestHandlerKernel(function (
            $request,
            $type,
            $catch
        ) {
    ...
    public function testUntrustedHeadersAreRemoved()
    {
        ...
        $kernel = new TestSubRequestHandlerKernel(function (
            ...
            $this->assertSame(
                'for="10.0.0.1";host="localhost";proto=http',
    ...
    public function testTrustedForwardedHeader()
    {
        ...
        $request->headers->set(
            'Forwarded',
            'for="10.0.0.2";host="foo.bar:1234";proto=https'
        );
    ...
    {
        return [Request::getTrustedProxies(), Request::getTrustedHeaderSet()];
    }
}
