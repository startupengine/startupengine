...
class ServiceSubscriberTraitTest extends TestCase
{
    public function testMethodsOnParentsAndChildrenAreIgnoredInGetSubscribedServices()
    {
        $expected = array(
            TestService::class .
                '::aService' => '?Symfony\Contracts\Tests\Service\Service2'
        );

        $this->assertEquals(
            $expected,
            ChildTestService::getSubscribedServices()
        );
    }
    ...
    public function testSetContainerIsCalledOnParent()
    {
        ...
        $this->assertSame(
            $container,
            (new TestService())->setContainer($container)
        );
    }
}
...
class TestService extends ParentTestService implements
