...
class TranslatorTest extends TestCase
{
    ...
    public function testInterval($expected, $number, $interval)
    {
        ...
        $this->assertEquals(
            $expected,
            $translator->trans($interval . ' foo|[1,Inf[ bar', array(
                '%count%' => $number
            ))
        );
    }
    ...
    public function testReturnMessageIfExactlyOneStandardRuleIsGiven()
    {
        ...
        $this->assertEquals(
            ...
            $translator->trans('There are two apples', array('%count%' => 2))
        );
    }
     ...
     */
    public function testThrowExceptionIfMatchingMessageCannotBeFound(
        $id,
        $number
    ) {
        $translator = $this->getTranslator();
