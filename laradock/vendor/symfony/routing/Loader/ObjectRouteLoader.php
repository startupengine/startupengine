...
abstract class ObjectRouteLoader extends Loader
{
    ...
    public function load($resource, $type = null)
    {
        ...
        if (!$routeCollection instanceof RouteCollection) {
            $type = \is_object($routeCollection)
                ? \get_class($routeCollection)
                : \gettype($routeCollection);
        ...
        $this->addClassResource(
            new \ReflectionClass($loaderObject),
            $routeCollection
        );
    ...
    private function addClassResource(
