...
class PhpMatcherDumperTest extends TestCase
{
    ...
    public function getRouteCollections()
    {
        ...
        $collection->add(
            'foo',
            new Route('/foo/{bar}', ['def' => 'test'], ['bar' => 'baz|symfony'])
        );
        // method requirement
        $collection->add(
            'bar',
            new Route('/bar/{foo}', [], [], [], '', [], ['GET', 'head'])
        );
        // GET method requirement automatically adds HEAD as valid
        $collection->add(
            'barhead',
            new Route('/barhead/{foo}', [], [], [], '', [], ['GET'])
        );
        // simple
        ...
        $collection->add(
            'baz5',
            new Route('/test/{foo}/', [], [], [], '', [], ['post'])
        );
        // complex name
        $collection->add(
            'baz.baz6',
            new Route('/test/{foo}/', [], [], [], '', [], ['put'])
        );
        // defaults without variable
        $collection->add('foofoo', new Route('/foofoo', ['def' => 'test']));
        // pattern with quotes
        $collection->add(
            'quoter',
            new Route('/{quoter}', [], ['quoter' => '[\']+'])
        );
        // space in pattern
        ...
        $redirectCollection->add(
            'secure',
            new Route('/secure', [], [], [], '', ['https'])
        );

        // force HTTP redirection
        $redirectCollection->add(
            'nonsecure',
            new Route('/nonsecure', [], [], [], '', ['http'])
        );
        ...
        $headMatchCasesCollection->add(
            'just_head',
            new Route('/just_head', [], [], [], '', [], ['HEAD'])
        );
        $headMatchCasesCollection->add(
            'head_and_get',
            new Route('/head_and_get', [], [], [], '', [], ['HEAD', 'GET'])
        );
        $headMatchCasesCollection->add(
            'get_and_head',
            new Route('/get_and_head', [], [], [], '', [], ['GET', 'HEAD'])
        );
        $headMatchCasesCollection->add(
            'post_and_head',
            new Route('/post_and_head', [], [], [], '', [], ['POST', 'HEAD'])
        );
        $headMatchCasesCollection->add(
            'put_and_post',
            new Route('/put_and_post', [], [], [], '', [], ['PUT', 'POST'])
        );
        $headMatchCasesCollection->add(
        ...
        $groupOptimisedCollection->add(
            'nested_wildcard',
            new Route('/nested/{param}')
        );
        $groupOptimisedCollection->add(
            'nested_a',
            new Route('/nested/group/a/')
        );
        $groupOptimisedCollection->add(
            'nested_b',
            new Route('/nested/group/b/')
        );
        $groupOptimisedCollection->add(
            'nested_c',
            new Route('/nested/group/c/')
        );

        $groupOptimisedCollection->add(
            'slashed_a',
            new Route('/slashed/group/')
        );
        $groupOptimisedCollection->add(
            'slashed_b',
            new Route('/slashed/group/b/')
        );
        $groupOptimisedCollection->add(
            'slashed_c',
            new Route('/slashed/group/c/')
        );

        /* test case 6 & 7 */
        $trailingSlashCollection = new RouteCollection();
        $trailingSlashCollection->add(
            'simple_trailing_slash_no_methods',
            new Route('/trailing/simple/no-methods/', [], [], [], '', [], [])
        );
        $trailingSlashCollection->add(
            'simple_trailing_slash_GET_method',
            new Route(
                '/trailing/simple/get-method/',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/trailing/regex/no-methods/{param}/',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/trailing/regex/get-method/{param}/',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/trailing/regex/head-method/{param}/',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/trailing/regex/post-method/{param}/',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route('/not-trailing/simple/no-methods', [], [], [], '', [], [])
        );
        $trailingSlashCollection->add(
            'simple_not_trailing_slash_GET_method',
            new Route(
                '/not-trailing/simple/get-method',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/not-trailing/simple/head-method',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/not-trailing/simple/post-method',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/not-trailing/regex/no-methods/{param}',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/not-trailing/regex/get-method/{param}',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/not-trailing/regex/head-method/{param}',
                [],
                [],
                [],
                '',
        ...
        $trailingSlashCollection->add(
            ...
            new Route(
                '/not-trailing/regex/post-method/{param}',
                [],
                [],
                [],
                '',
        ...
        $unicodeCollection->add(
            'a',
            new Route('/{a}', [], ['a' => 'a'], ['utf8' => false])
        );
        $unicodeCollection->add(
            'b',
            new Route('/{a}', [], ['a' => '.'], ['utf8' => true])
        );
        $unicodeCollection->add(
            'c',
            new Route('/{a}', [], ['a' => '.'], ['utf8' => false])
        );
        ...
        $demoCollection->add(
            'c',
            (new Route('/admin/post/{id}'))->setRequirements(['id' => '\d+'])
        );
        $demoCollection->add(
            'd',
            (new Route('/admin/post/{id}/edit'))->setRequirements([
                'id' => '\d+'
            ])
        );
        $demoCollection->add(
            'e',
            (new Route('/admin/post/{id}/delete'))->setRequirements([
                'id' => '\d+'
            ])
        );
        ...
        $demoCollection->add(
            'h',
            (new Route('/blog/page/{page}'))->setRequirements(['id' => '\d+'])
        );
        $demoCollection->add(
            'i',
            (new Route('/blog/posts/{page}'))->setRequirements(['id' => '\d+'])
        );
        $demoCollection->add(
            'j',
            (new Route('/blog/comments/{id}/new'))->setRequirements([
                'id' => '\d+'
            ])
        );
        ...
        $hostCollection->add(
            'r1',
            (new Route('abc{foo}'))->setHost('{foo}.exampple.com')
        );
        $hostCollection->add(
            'r2',
            (new Route('abc{foo}'))->setHost('{foo}.exampple.com')
    ...
    private function generateDumpedMatcher(
        RouteCollection $collection,
        $redirectableStub = false
    ) {
        $options = ['class' => $this->matcherClass];

        if ($redirectableStub) {
            $options['base_class'] =
                '\Symfony\Component\Routing\Tests\Matcher\Dumper\RedirectableUrlMatcherStub';
        }
...
abstract class RedirectableUrlMatcherStub extends UrlMatcher implements
