...
class RouteCompilerTest extends TestCase
{
     ...
     */
    public function testCompileImplicitUtf8Data(
        $name,
        $arguments,
        $prefix,
        $regex,
        ...
        return [
            ...
            [
                ...
                [
                    ...
                    [],
                    [],
                    ['compiler_class' => Utf8RouteCompiler::class]
                ],
                '/foo',
     ...
     */
    public function testCompileWithHost(
        $name,
        $arguments,
        $prefix,
        $regex,
    ...
    public function testRouteWithTooLongVariableName()
    {
        $route = new Route(
            sprintf(
                '/{%s}',
                str_repeat('a', RouteCompiler::VARIABLE_MAXIMUM_LENGTH + 1)
            )
        );
        $route->compile();
    }
