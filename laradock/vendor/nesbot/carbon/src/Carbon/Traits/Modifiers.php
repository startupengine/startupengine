...
trait Modifiers
{
    ...
    public function nthOfMonth($nth, $dayOfWeek)
    {
        ...
        return $date->rawFormat('Y-m') === $check
            ? $this->modify($date)
            : false;
    }
    ...
    public function firstOfQuarter($dayOfWeek = null)
    {
        return $this->setDate(
            $this->year,
            $this->quarter * static::MONTHS_PER_QUARTER - 2,
            1
    ...
    public function lastOfQuarter($dayOfWeek = null)
    {
        return $this->setDate(
            $this->year,
            $this->quarter * static::MONTHS_PER_QUARTER,
            1
    ...
    public function nthOfQuarter($nth, $dayOfWeek)
    {
        ...
        return $lastMonth < $date->month || $year !== $date->year
            ? false
            : $this->modify($date);
    }
    ...
    {
        return $this->addRealMicroseconds(
            (int) ($this->diffInRealMicroseconds(
    ...
    {
        return $this->diffInRealMicroseconds($date1) <
            $this->diffInRealMicroseconds($date2)
            ? $date1
            : $date2;
    }
