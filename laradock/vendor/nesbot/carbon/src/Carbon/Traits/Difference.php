...
trait Difference
{
    ...
    public function diffAsCarbonInterval($date = null, $absolute = true)
    {
        return static::fixDiffInterval(
            $this->diff($this->resolveCarbon($date), $absolute),
            $absolute
        );
    }
    ...
    public function diffInMonths($date = null, $absolute = true)
    {
        ...
        return $this->diffInYears($date, $absolute) * static::MONTHS_PER_YEAR +
            (int) $this->diff($date, $absolute)->format('%r%m');
    }
    ...
    {
        return (int) ($this->diffInDays($date, $absolute) /
    ...
    public function diffFiltered(
        ...
        $options =
            ...
            ($this->isMutable() ? 0 : CarbonPeriod::IMMUTABLE);
        $diff = $ci
            ->toPeriod($start, $end, $options)
            ->filter($callback)
            ->count();
    ...
    {
        return (int) ($this->diffInSeconds($date, $absolute) /
    ...
    {
        return (int) ($this->diffInRealSeconds($date, $absolute) /
            static::SECONDS_PER_MINUTE /
            static::MINUTES_PER_HOUR);
    }
    ...
    public function diffInSeconds($date = null, $absolute = true)
    {
        ...
        $value =
            (($diff->days * static::HOURS_PER_DAY + $diff->h) *
                static::MINUTES_PER_HOUR +
                $diff->i) *
                static::SECONDS_PER_MINUTE +
            $diff->s;
    ...
    {
        return (int) ($this->diffInMicroseconds($date, $absolute) /
            static::MICROSECONDS_PER_MILLISECOND);
    }
    ...
    {
        return (int) ($this->diffInRealMicroseconds($date, $absolute) /
            static::MICROSECONDS_PER_MILLISECOND);
    }
    ...
    {
        return $this->diffInMicroseconds($date, $absolute) /
            static::MICROSECONDS_PER_SECOND;
    }
    ...
    {
        return $this->floatDiffInSeconds($date, $absolute) /
            static::SECONDS_PER_MINUTE;
    }
    ...
    {
        return $this->floatDiffInMinutes($date, $absolute) /
            static::MINUTES_PER_HOUR;
    }
    ...
    public function floatDiffInDays($date = null, $absolute = true)
    {
        ...
        return ($hoursDiff < 0 ? -1 : 1) * $this->diffInDays($date) +
            ($hoursDiff % static::HOURS_PER_DAY) / static::HOURS_PER_DAY;
    }
    ...
    public function floatDiffInMonths($date = null, $absolute = true)
    {
        ...
        $startOfMonthAfterFloorEnd = $floorEnd
            ->copy()
            ->addMonth()
            ->startOfMonth();
        ...
        if ($startOfMonthAfterFloorEnd > $end) {
            return $sign *
                ($monthsDiff +
                    $floorEnd->floatDiffInDays($end) / $floorEnd->daysInMonth);
        }

        return $sign *
            ($monthsDiff +
                $floorEnd->floatDiffInDays($startOfMonthAfterFloorEnd) /
                    $floorEnd->daysInMonth +
                $startOfMonthAfterFloorEnd->floatDiffInDays($end) /
                    $end->daysInMonth);
    }
    ...
    public function floatDiffInYears($date = null, $absolute = true)
    {
        ...
        $startOfYearAfterFloorEnd = $floorEnd
            ->copy()
            ->addYear()
            ->startOfYear();
        ...
        if ($startOfYearAfterFloorEnd > $end) {
            return $sign *
                ($yearsDiff +
                    $floorEnd->floatDiffInDays($end) / $floorEnd->daysInYear);
        }

        return $sign *
            ($yearsDiff +
                $floorEnd->floatDiffInDays($startOfYearAfterFloorEnd) /
                    $floorEnd->daysInYear +
                $startOfYearAfterFloorEnd->floatDiffInDays($end) /
                    $end->daysInYear);
    }
    ...
    {
        return $this->diffInRealMicroseconds($date, $absolute) /
            static::MICROSECONDS_PER_SECOND;
    }
    ...
    {
        return $this->floatDiffInRealSeconds($date, $absolute) /
            static::SECONDS_PER_MINUTE;
    }
    ...
    {
        return $this->floatDiffInRealMinutes($date, $absolute) /
            static::MINUTES_PER_HOUR;
    }
    ...
    public function floatDiffInRealMonths($date = null, $absolute = true)
    {
        ...
        if ($startOfMonthAfterFloorEnd > $end) {
            return $sign *
                ($monthsDiff +
                    $floorEnd->floatDiffInRealDays($end) /
                        $floorEnd->daysInMonth);
        }

        return $sign *
            ($monthsDiff +
                $floorEnd->floatDiffInRealDays($startOfMonthAfterFloorEnd) /
                    $floorEnd->daysInMonth +
                $startOfMonthAfterFloorEnd->floatDiffInRealDays($end) /
                    $end->daysInMonth);
    }
    ...
    public function floatDiffInRealYears($date = null, $absolute = true)
    {
        ...
        return $sign *
            ($yearsDiff +
                $floorEnd->floatDiffInRealDays($startOfYearAfterFloorEnd) /
                    $floorEnd->daysInYear +
                $startOfYearAfterFloorEnd->floatDiffInRealDays($end) /
                    $end->daysInYear);
    }
    ...
    public function diffForHumans(
        ...
        if (is_array($other)) {
            $other['syntax'] = array_key_exists('syntax', $other)
                ? $other['syntax']
                : $syntax;
            $syntax = $other;
        ...
        $intSyntax = (int) $intSyntax === null
            ? static::DIFF_RELATIVE_AUTO
            : $intSyntax;
        $intSyntax =
            $intSyntax === static::DIFF_RELATIVE_AUTO && $other === null
                ? static::DIFF_RELATIVE_TO_NOW
                : $intSyntax;
        ...
        return $this->diffAsCarbonInterval($other, false)
            ...
            ->forHumans(
                ...
                $parts,
                $options ??
                    $this->localHumanDiffOptions ??
                    static::getHumanDiffOptions()
            );
    }
    ...
    public function to(
        ...
        return $this->resolveCarbon($other)->diffForHumans(
            $this,
            $syntax,
            $short,
            $parts,
    ...
    public function fromNow(
        ...
        if ($syntax instanceof DateTimeInterface) {
            [$other, $syntax, $short, $parts, $options] = array_pad(
                func_get_args(),
                5,
                null
            );
    ...
    public function calendar($referenceTime = null, array $formats = [])
    {
        ...
        $other = $this->resolveCarbon($referenceTime)
            ->copy()
