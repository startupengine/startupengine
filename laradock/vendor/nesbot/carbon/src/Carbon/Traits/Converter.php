...
trait Converter
{
    ...
    public function toRfc7231String()
    {
        return $this->copy()
            ->setTimezone('GMT')
            ->rawFormat(
                defined('static::RFC7231_FORMAT')
                    ? static::RFC7231_FORMAT
                    : CarbonInterface::RFC7231_FORMAT
            );
    }
    ...
    public function toString()
    {
        return $this->copy()
            ->locale('en')
            ->isoFormat('ddd MMM DD YYYY HH:mm:ss [GMT]ZZ');
    }
