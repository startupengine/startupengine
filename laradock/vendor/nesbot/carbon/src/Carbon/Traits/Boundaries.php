...
trait Boundaries
{
    ...
    {
        return $this->setTime(
            static::HOURS_PER_DAY - 1,
            static::MINUTES_PER_HOUR - 1,
            static::SECONDS_PER_MINUTE - 1,
            static::MICROSECONDS_PER_SECOND - 1
        );
    }
    ...
    public function endOfDecade()
    {
        $year =
            $this->year -
            ($this->year % static::YEARS_PER_DECADE) +
    ...
    public function endOfCentury()
    {
        $year =
            $this->year -
            1 -
            (($this->year - 1) % static::YEARS_PER_CENTURY) +
            static::YEARS_PER_CENTURY;
    ...
    {
        $year =
            $this->year - (($this->year - 1) % static::YEARS_PER_MILLENNIUM);
    ...
    public function endOfMillennium()
    {
        $year =
            $this->year -
            1 -
            (($this->year - 1) % static::YEARS_PER_MILLENNIUM) +
            static::YEARS_PER_MILLENNIUM;
