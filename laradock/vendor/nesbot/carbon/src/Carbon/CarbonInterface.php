...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
    ...
    public const TRANSLATE_ALL =
        self::TRANSLATE_MONTHS |
        self::TRANSLATE_DAYS |
        self::TRANSLATE_UNITS |
        self::TRANSLATE_MERIDIEM;
     ...
     * @return $this
     */
    public function setLocalTranslator(
