...
class ServiceProvider extends \Illuminate\Support\ServiceProvider
{
    public function boot()
    {
        ...
        if (
            $events instanceof EventDispatcher ||
            $events instanceof Dispatcher
        ) {
            $events->listen(
                class_exists('Illuminate\Foundation\Events\LocaleUpdated')
    ...
    public function updateLocale()
    {
        ...
        if (
            ...
            $translator instanceof IlluminateTranslator
        ) {
