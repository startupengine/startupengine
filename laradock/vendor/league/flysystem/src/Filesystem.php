...
class Filesystem implements FilesystemInterface
{
    ...
    public function writeStream($path, $resource, array $config = [])
    {
        ...
        return (bool) $this->getAdapter()->writeStream(
            $path,
            $resource,
            $config
        );
    ...
    public function put($path, $contents, array $config = [])
    {
        ...
        if (
            !$this->getAdapter() instanceof CanOverwriteFiles &&
            $this->has($path)
        ) {
            return (bool) $this->getAdapter()->update(
                $path,
                $contents,
                $config
            );
    ...
    public function putStream($path, $resource, array $config = [])
    {
        ...
        if (
            ...
            return (bool) $this->getAdapter()->updateStream(
                $path,
                $resource,
                $config
            );
    ...
    public function listContents($directory = '', $recursive = false)
    {
        ...
        return (new ContentListingFormatter(
            $directory,
            $recursive,
            $this->config->get('case_sensitive', true)
    ...
    public function getMimetype($path)
    {
        ...
        if (
            ...
            !array_key_exists('mimetype', $object)
        ) {
            return false;
        }
    ...
    public function getTimestamp($path)
    {
        ...
        if (
            ...
            !array_key_exists('timestamp', $object)
        ) {
            return false;
        }
    ...
    public function getVisibility($path)
    {
        ...
        if (
            ...
            !array_key_exists('visibility', $object)
        ) {
            return false;
        }
    ...
    {
        if (
            $this->config->get('disable_asserts', false) === false &&
            !$this->has($path)
        ) {
