...
class NormalizerFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatExceptions()
    {
        ...
        unset(
            $formatted['exception']['trace'],
            $formatted['exception']['previous']
        );
    ...
    public function testConvertsInvalidEncodingAsLatin9()
    {
        ...
        $res = $reflMethod->invoke($formatter, array(
            'message' => "\xA4\xA6\xA8\xB4\xB8\xBC\xBD\xBE"
        ));
    ...
    public function testExceptionTraceDoesNotLeakCallUserFuncArgs()
    {
        ...
        $this->assertSame(
            '{"function":"throwHelper","class":"Monolog\\\\Formatter\\\\NormalizerFormatterTest","type":"->","args":["[object] (Monolog\\\\Formatter\\\\TestInfoLeak)","' .
