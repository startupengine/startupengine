...
class SignalHandlerTest extends TestCase
{
    ...
    public function testRegisterSignalHandler()
    {
        ...
        $errHandler->registerSignalHandler(
            SIGURG,
            LogLevel::INFO,
            false,
            false,
     ...
     */
    public function testRegisterDefaultPreviousSignalHandler(
        $signo,
        $callPrevious,
        $expected
    ) {
    ...
    public function testRegisterCallablePreviousSignalHandler($callPrevious)
    {
        ...
        $errHandler = new SignalHandler($logger);
        $previousCalled = 0;
        pcntl_signal(SIGURG, function ($signo, array $siginfo = null) use (
            &$previousCalled
        ) {
            ++$previousCalled;
        });
    ...
    {
        return array(array(false), array(true), array(false), array(true));
    }
