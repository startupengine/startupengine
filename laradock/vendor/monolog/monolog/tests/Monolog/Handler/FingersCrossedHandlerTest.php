...
class FingersCrossedHandlerTest extends TestCase
{
    ...
    {
        $test = new TestHandler();
        $handler = new FingersCrossedHandler(function ($record, $handler) use (
            $test
        ) {
            return $test;
        });
    ...
    public function testChannelLevelActivationStrategy()
    {
        ...
        $handler = new FingersCrossedHandler(
            $test,
            new ChannelLevelActivationStrategy(Logger::ERROR, array(
    ...
    public function testChannelLevelActivationStrategyWithPsrLevels()
    {
        ...
        $handler = new FingersCrossedHandler(
            $test,
            new ChannelLevelActivationStrategy('error', array(
                'othertest' => 'debug'
            ))
        );
        $handler->handle($this->getRecord(Logger::WARNING));
