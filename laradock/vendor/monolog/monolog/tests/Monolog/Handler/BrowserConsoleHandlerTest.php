...
class BrowserConsoleHandlerTest extends TestCase
{
    ...
    public function testStyling()
    {
        ...
        $handler->handle(
            $this->getRecord(Logger::DEBUG, 'foo[[bar]]{color: red}')
        );
...
EOF;
    ...
    public function testAutolabel()
    {
        ...
        $handler->handle(
            $this->getRecord(Logger::DEBUG, '[[foo]]{macro: autolabel}')
        );
        $handler->handle(
            $this->getRecord(Logger::DEBUG, '[[bar]]{macro: autolabel}')
        );
        $handler->handle(
            $this->getRecord(Logger::DEBUG, '[[foo]]{macro: autolabel}')
        );
...
EOF;
    ...
    public function testContext()
    {
        ...
        $handler->handle(
            $this->getRecord(Logger::DEBUG, 'test', array('foo' => 'bar'))
        );
