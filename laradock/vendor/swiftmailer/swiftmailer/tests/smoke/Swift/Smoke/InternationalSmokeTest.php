...
class Swift_Smoke_InternationalSmokeTest extends SwiftMailerSmokeTestCase
{
    ...
    public function testAttachmentSending()
    {
        ...
        $message = (new Swift_Message())
            ...
            ->setFrom([
                SWIFT_SMOKE_EMAIL_ADDRESS => 'Χριστοφορου (Swift Mailer)'
            ])
            ->setTo(SWIFT_SMOKE_EMAIL_ADDRESS)
            ->setBody(
                'This message should contain an attached ZIP file (named "κείμενο, εδάφιο, θέμα.zip").' .
                    PHP_EOL .
                    ...
                    PHP_EOL .
                    PHP_EOL .
                    'Following is some arbitrary Greek text:' .
                    PHP_EOL .
                    'Δεν βρέθηκαν λέξεις.'
            )
            ->attach(
