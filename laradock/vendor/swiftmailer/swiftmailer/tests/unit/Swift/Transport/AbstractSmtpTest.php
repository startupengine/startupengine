...
abstract class Swift_Transport_AbstractSmtpTest extends \SwiftMailerTestCase
{
     ...
     CONNECTION ESTABLISHMENT
        ...
        */
        ...
        try {
            $this->assertFalse(
                $smtp->isStarted(),
                '%s: SMTP should begin non-started'
            );
            $smtp->start();
            $this->assertTrue(
                $smtp->isStarted(),
                '%s: start() should have started connection'
            );
        } catch (Exception $e) {
    ...
    public function testBadGreetingCausesException()
    {
        ...
        try {
            ...
            $smtp->start();
            $this->fail(
                '554 greeting indicates an error and should cause an exception'
            );
        } catch (Swift_TransportException $e) {
            $this->assertFalse(
                $smtp->isStarted(),
                '%s: start() should have failed'
            );
        }
    }
     ...
     */
        ...
        try {
            ...
            $this->fail(
                'Starting SMTP should send HELO and accept 250 response'
            );
        }
    }
    ...
    public function testInvalidHeloResponseCausesException()
    {
        ...
        try {
            ...
            $this->assertFalse(
                $smtp->isStarted(),
                '%s: SMTP start() should have failed'
            );
        }
    }
    ...
    public function testUtf8AddressWithUtf8Encoder()
    {
        ...
        $smtp = $this->getTransport(
            $buf,
            null,
            new Swift_AddressEncoder_Utf8AddressEncoder()
        );
        $message = $this->createMessage();
    ...
    public function testBadResponseAfterDataTransmissionCausesException()
    {
        ...
        try {
            ...
            $smtp->send($message);
            $this->fail(
                '250 is the expected response after a DATA transmission (not observed)'
            );
        } catch (Swift_TransportException $e) {
        }
    }
    ...
    public function testResponseCodesAreValidated()
    {
        ...
        try {
            ...
            $this->fail(
                'A 250 or 251 response was needed but 551 was returned.'
            );
        } catch (Swift_TransportException $e) {
        }
    }
    ...
    public function testSendingRegeneratesMessageId()
    {
        ...
        $message
            ...
            ->zeroOrMoreTimes()
            ->andReturn(['foo@bar' => null]);
        $message->shouldReceive('generateId')->once();
