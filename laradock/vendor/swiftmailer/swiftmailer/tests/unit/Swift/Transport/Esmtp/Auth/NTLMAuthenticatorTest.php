...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticatorTest extends
    \SwiftMailerTestCase
{
    ...
    public function testLMv1Generator()
    {
        ...
        $login = $this->getAuthenticator();
        $lmv1Result = $this->invokePrivateMethod('createLMPassword', $login, [
            $password,
            hex2bin($challenge)
        ]);
    ...
    public function testLMv2Generator()
    {
        ...
        $login = $this->getAuthenticator();
        $lmv2Result = $this->invokePrivateMethod('createLMv2Password', $login, [
            $password,
            $username,
            $domain,
            hex2bin($challenge),
            hex2bin('ffffff0011223344')
        ]);
    ...
    public function testMessage3v1Generator()
    {
        ...
        $message3T =
            '';

        $login = $this->getAuthenticator();
        $message3 = $this->invokePrivateMethod('createMessage3', $login, [
            $domain,
            $username,
            $workstation,
            hex2bin($lmResponse),
            hex2bin($ntlmResponse)
        ]);
    ...
    public function testMessage3v2Generator()
    {
        ...
        $ntlmResponse =
            'caa4da8f25d5e840974ed8976d3ada46010100000000000030fa7e3c677bc301f5ce3d2401c8f6e90000000002000c0054004500530054004e00540001000c004d0045004d0042004500520003001e006d0065006d006200650072002e0074006500730074002e0063006f006d000000000000000000';
    ...
    public function testGetDomainAndUsername()
    {
        ...
        $login = $this->getAuthenticator();
        list($domain, $user) = $this->invokePrivateMethod(
    ...
    public function testSuccessfulAuthentication()
    {
        ...
        $agent
            ...
            ->andReturn(
                '334 ' .
                    base64_encode(
                        hex2bin(
                            ''
                        )
                    )
            );
        $agent
            ...
            ->with(
                base64_encode(
                    $this->invokePrivateMethod('createMessage3', $ntlm, [
                        $domain,
                        $username,
                        hex2bin('4d0045004d00420045005200'),
                        hex2bin(
                            'bf2e015119f6bdb3f6fdb768aa12d478f5ce3d2401c8f6e9'
                        ),
                        hex2bin(
                            'caa4da8f25d5e840974ed8976d3ada46010100000000000030fa7e3c677bc301f5ce3d2401c8f6e90000000002000c0054004500530054004e00540001000c004d0045004d0042004500520003001e006d0065006d006200650072002e0074006500730074002e0063006f006d000000000000000000'
                        )
        ...
        $this->assertTrue(
            $ntlm->authenticate(
                ...
                $username . '@' . $domain,
                $secret,
                hex2bin('30fa7e3c677bc301'),
                hex2bin('f5ce3d2401c8f6e9')
            ),
