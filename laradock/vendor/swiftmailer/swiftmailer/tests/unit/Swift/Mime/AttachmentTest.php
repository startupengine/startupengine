...
class Swift_Mime_AttachmentTest extends Swift_Mime_AbstractMimeEntityTest
{
    ...
    public function testDispositionIsSetInHeader()
    {
        ...
        $disposition
            ...
            ->once()
            ->with('inline');
        $disposition->shouldReceive('setFieldBodyModel')->zeroOrMoreTimes();
    ...
    {
        $cType = $this->createHeader('Content-Type', '', [], false);
        $cType
            ->shouldReceive('setFieldBodyModel')
            ->once()
    ...
    protected function createAttachment(
        ...
        return new Swift_Mime_Attachment(
            $headers,
            $encoder,
            $cache,
            $idGenerator,
