...
@if(isset($page->content()->settings) && isset($page->content()->settings->use_global_menu) && $page->content()->settings->use_global_menu == false && View::exists('theme.templates.global.menu'))
