...
@section('alt_content')
    ...
    <div class="row row-eq-height">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="pagesApp" v-if="info !== null">
            ...
            <?php $tableFooter = ' '; ?>
            <?php $tableRowConditions = "item.views > 0"; ?>
            <?php $tableRowNoResultsConditions = 'item.views != null && item.views > 1'; ?>
            <?php $noResults = '<div align="center" class="pt-4" v-if="info.data.every(function(item){return (item.views > 0 )})" ><img src="/images/illustrations/undraw_content_vbqo.svg" style="max-width:180px;" class="mb-3 pb-3"><p class="card-text mt-4 empty-message pt-3">Nothing here. Try adding some pages.<br><a href="/admin/pages" class="btn btn-primary btn-pill mt-3">Pages</a></p></div>'; ?>
