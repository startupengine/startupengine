...
@section('alt_content')
    ...
    <div class="row row-eq-height">
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="contentApp" v-if="info !== null">
            ...
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/content/',  'TABLE_FOOTER' => $tableFooter, 'TABLE_ROW_CONDITIONS' => $tableRowConditions, 'TABLE_ROW_NO_RESULTS_CONDITIONS' => $tableRowNoResultsConditions, 'TABLE_ROW_NO_RESULTS_MESSAGE' => 'No results.', 'WRAPPER_CLASS' => '']) !!}
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="pagesApp" v-if="info !== null">
            ...
            <?php $tableRowConditions = "item.views > 0"; ?>
            <?php $tableRowNoResultsConditions = 'item.views == 0'; ?>
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/pages/', 'TABLE_FOOTER' => $tableFooter, 'TABLE_ROW_CONDITIONS' => $tableRowConditions, 'TABLE_ROW_NO_RESULTS_CONDITIONS' => $tableRowNoResultsConditions, 'TABLE_ROW_NO_RESULTS_MESSAGE' => 'No results.', 'WRAPPER_CLASS' => '']) !!}
        </div>
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="productsApp" v-if="info !== null">
            ...
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/products/', 'TABLE_FOOTER' => $tableFooter, 'TABLE_ROW_CONDITIONS' => $tableRowConditions, 'TABLE_ROW_NO_RESULTS_CONDITIONS' => $tableRowNoResultsConditions, 'TABLE_ROW_NO_RESULTS_MESSAGE' => 'No results.', 'WRAPPER_CLASS' => '']) !!}
        </div>
    </div>
@endsection

@section('scripts')
    {!! renderResourceTableScriptsDynamically(['url' => 'http://127.0.0.1:8000/api/resources/content', 'div_id' => 'contentApp', 'LIMIT' => 5, 'SORT_STRING' => '&sort=-views&sortMethod=COUNT']) !!}
    {!! renderResourceTableScriptsDynamically(['url' => 'http://127.0.0.1:8000/api/resources/page', 'div_id' => 'pagesApp', 'LIMIT' => 5, 'SORT_STRING' => '&sort=-views&sortMethod=COUNT']) !!}
    {!! renderResourceTableScriptsDynamically(['url' => 'http://127.0.0.1:8000/api/resources/product', 'div_id' => 'productsApp', 'LIMIT' => 5, 'SORT_STRING' => '&sort=-purchases&sortMethod=COUNT']) !!}
@endsection