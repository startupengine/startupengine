...
@section('alt_content')
    ...
    <div class="row row-eq-height">
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="contentApp" v-if="info !== null">
            ...
            <?php $tableFooter = '<a href="/admin/content" class="btn btn-outline-primary btn-pill">View All Content <i class="fa fa-fw fa-arrow-right ml-1"></i></a>'; ?>
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/content/',  'TABLE_FOOTER' => $tableFooter, 'WRAPPER_CLASS' => '']) !!}
        </div>
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="pagesApp" v-if="info !== null">
            ...
            <?php $tableFooter = '<a href="/admin/pages" class="btn btn-outline-primary btn-pill">View All Pages <i class="fa fa-fw fa-arrow-right ml-1"></i></a>'; ?>
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/pages/', 'TABLE_FOOTER' => $tableFooter,'WRAPPER_CLASS' => '']) !!}
        </div>
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="productsApp" v-if="info !== null">
            ...
            <?php $tableFooter = '<a href="/admin/products" class="btn btn-outline-primary btn-pill">View All Products <i class="fa fa-fw fa-arrow-right ml-1"></i></a>'; ?>
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/products/', 'TABLE_FOOTER' => $tableFooter, 'WRAPPER_CLASS' => '']) !!}
        </div>
    </div>
@endsection
