...
?>
            ...
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/content/',  'WRAPPER_CLASS' => 'h-100']) !!}
...
?>
            ...
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/pages/', 'WRAPPER_CLASS' => 'h-100']) !!}
        </div>
...
?>
            ...
            {!! renderResourceTableHtmlDynamically(['HEADER' => $header, 'TABLE_HEADER' => $tableHeader, 'TABLE_ROW' => $tableRow, 'PATH' => '/admin/products/','WRAPPER_CLASS' => 'h-100']) !!}
        </div>
    </div>
@endsection
