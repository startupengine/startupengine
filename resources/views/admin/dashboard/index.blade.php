...
@section('alt_content')
    ...
    <div class="row row-eq-height">
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="contentApp" v-if="info !== null">
            ...
            <?php $noResults = '<div align="center" class="pt-4"><img src="/images/illustrations/undraw_typewriter_i8xd.svg" style="max-width:180px;" class="mb-3 pb-3"><p class="card-text mt-4 empty-message pt-3">Nothing here. Try adding some content.<br><a href="/admin/content" class="btn btn-primary btn-pill mt-2">Content</a></p></div>'; ?>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="pagesApp" v-if="info !== null">
            ...
            <?php $tableRowConditions = "item.views > 0"; ?>
            <?php $tableRowNoResultsConditions = 'item.views == 0'; ?>
            <?php $noResults = '<div align="center" class="pt-4"><img src="/images/illustrations/undraw_content_vbqo.svg" style="max-width:180px;" class="mb-3 pb-3"><p class="card-text mt-4 empty-message pt-3">Nothing here. Try adding some pages.<br><a href="/admin/pages" class="btn btn-primary btn-pill mt-2">Pages</a></p></div>'; ?>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 mb-4" id="productsApp" v-if="info !== null">
            ...
            <?php $noResults = '<div align="center" class="pt-4"><img src="/images/illustrations/undraw_revenue_3osh.svg" style="max-width:180px;" class="mb-3 pb-3"><p class="card-text mt-4 empty-message pt-3">Nothing here. Try adding some products.<br><a href="/admin/products" class="btn btn-primary btn-pill mt-2">Products</a></p></div>'; ?>
