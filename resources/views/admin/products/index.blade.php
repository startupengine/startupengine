...
@section('content')
    ...
    <?php $header = '<div class="btn-group">
                            ...
                            <span class="btn btn-light border" v-bind:class="{ active: filters.type==\'json->sections->about->fields->type=Software%20Subscription\'}"  v-on:click="updateFilters({\'type\':\'json->sections->about->fields->type=Software%20Subscription\'})">
                                <span>Software <span class="hiddenOnMobile">Subscriptions</span></span>
                            </span>
                            <span class="btn btn-light border" v-bind:class="{ active: filters.type==\'json->sections->about->fields->type=Content%20Subscription\'}"   v-on:click="updateFilters({\'type\':\'json->sections->about->fields->type=Content%20Subscription\'})">
                                <span>Content <span class="hiddenOnMobile">Subscriptions</span></span>
                            </span>
                            <span class="btn btn-light border"  v-bind:class="{ active: filters.type==\'json->sections->about->fields->type=Physical%20Product\'}" v-on:click="updateFilters({\'type\':\'json->sections->about->fields->type=Physical%20Product\'})">
                                <span><span class="hiddenOnMobile">Physical </span>Goods</span>
                            </span>
                        </div>'; ?>
...
@section('scripts')
    {!! renderResourceTableScriptsDynamically(['url' =>  URL::to('/').'/api/resources/product', 'FILTERS' => "{'type':'json->sections->about->fields->type=Software%20Subscription'}", 'VUE_APP_NAME' => 'productsApp', 'LIMIT' => 1000]) !!}
@endsection