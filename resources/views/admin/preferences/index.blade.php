...
@section('page-title') User Preferences @endsection

@section('top-menu')
    <div class="col-md-6 col-sm-6 pull-right pageNav" align="right">
        <div class="btn-group mb-1"><a href="/admin/preferences/schemas" class="btn btn-outline-primary">Schemas</a>
        </div>
        {!! renderFilterButton() !!}
    </div>
@endsection
...
@section('content')
    ...
    <?php $header = 'List of all user preferences.'; ?>
        <?php $tableHeader = '<th scope="col" class="border-0" style="width:100px !important;text-align:left;">Name</th><th scope="col" class="border-0 hiddenOnMobile" style="text-align:left;width:100px;">Description</th><th scope="col" class="border-0 " style="text-align:left;width:auto;">User</th><th scope="col" class="border-0">&nbsp;</th>'; ?>
        <?php $tableRow = '<td align="left" style="width:100px;" class=""><span class="badge badge-type text-dark mr-2" style="width:100%;" >{{ item.name }}</span></td><td align="left" class="hiddenOnMobile"><span class="badge text-dark mr-2 px-0">{{ item.description }}</span></td><td style="width:auto;" align="left"><span class="badge text-dark mr-2 px-0 text-capitalize">{{ item.user.name }}</span></td><td align="center"  style="width:50px;vertical-align:middle;"><a href="#" class="btn btn-white" v-bind:href="\'/admin/preference/\' + item.id" class="btn btn-white" style="border-radius:15px;margin-right:5px;width:30px;height:30px;padding:7px 5px 6px 7px;"><i class="fa fa-fw fa-angle-right"></i></a></td>'; ?>
...
@section('scripts')
    {!! renderResourceTableScriptsDynamically(['url' => 'http://127.0.0.1:8000/api/resources/preference']) !!}
@endsection