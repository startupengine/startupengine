                ...
                <main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
                    <div class="main col-md-12" style="background:none;margin-top:25px;">
                        <div class="col-md-12">
                            ...
                            <div align="right">
                                <a href="/app/new/schema" class="btn btn-secondary-outline btn-round">New Content Type &nbsp;&nbsp;<i class="now-ui-icons ui-1_simple-add"></i></a>
                            </div>
                            ...
                            <table class="table clickable">
                                ...
                                @foreach($postTypes as $postType)
                                    <tr>
                                        ...
                                        <td>{{ $postType->title }}<br><span style="opacity:0.5;">{{$postType->json()->description}}</span></td>
                                        <td align="right">
                                            <a href="/app/edit/schema/{{ $postType->slug }}" class="btn btn-sm btn-secondary-outline defaultClick" style="">Edit Schema</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
