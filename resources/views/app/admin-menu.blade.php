<div class="mobile-nav hiddenOnDesktop">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <?php /* <button class="dropdown-item" style="text-align: left;border-color:#eee !important;" onclick="location.href='/app';"><i class="now-ui-icons design_bullet-list-67"></i>&nbsp; Dashboard</button> */ ?>
        ...
        <button class="dropdown-item" style="text-align: left;border-color:#eee !important;" onclick="location.href='/app/content';"><i class="now-ui-icons design_bullet-list-67"></i>&nbsp; Content</button>
