<div class="btn-group btn-xs mobile-nav">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <button class="dropdown-item" style="text-align: left;border-color:#eee !important;" onclick="location.href='/app/modules';"><i class="now-ui-icons design_app"></i>&nbsp; Modules</button>
