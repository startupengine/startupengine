<nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar"
    ...
    <ul class="nav flex-column" style="margin-top:15px;">
        ...
        <li class="nav-item">
            <a class="btn btn-secondary-outline btn-block btn-round " style="text-align: left;border-color:#eee !important;background:royalblue !important;color:#fff !important;" href="/app/dashboard"><i class="fa fa-th"></i>&nbsp; Dashboard</a>
        </li>
        ...
        <li class="nav-item">
            <a class="btn btn-secondary-outline btn-block btn-round"
               style="text-align: left;border-color:#eee !important;"
               href="/app/subscriptions"><i class="now-ui-icons shopping_box"></i>&nbsp; Products</a>
        </li>
