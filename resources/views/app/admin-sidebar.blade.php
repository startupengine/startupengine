<nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar" style="padding-left:35px;padding-right:25px;min-height:100vh;border-right:1px solid #eee;">
    <ul class="nav flex-column" style="margin-top:15px;">
        ...
        */ ?>
        <?php /*
        <li class="nav-item">
            <a class="btn btn-secondary-outline btn-block" style="text-align: left;border-color:#eee !important;" href="/app/experiments"><i class="now-ui-icons education_atom"></i>&nbsp; Experiments</a>
        </li>
        */ ?>
        <li class="nav-item">
