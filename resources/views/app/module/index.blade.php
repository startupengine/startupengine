                    ...
                    <div class="main col-md-12" style="background:none;margin-top:25px;">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-img-top" style="background:url('{{ $module->image }}'); background-size:contain;background-position:center;background-repeat:no-repeat;height:200px;width:100%;">&nbsp;</div>
                                <div class="card-body" style="min-height:auto;border-top:1px solid #eee;">{{ $module->description }}</div>
                                <div class="card-footer" align="center"><a href="/app/modules/{{$module->slug}}/settings" class="nav-link">Configure</a></div>
                            </div>
                        </div>
                        @endforeach
                    </div>
