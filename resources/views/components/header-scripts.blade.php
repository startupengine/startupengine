...
<script src='https://app.psychoanalytics.io/js/v1?site-id={{ env('PSYCHO-ANALYITICS-SITE-ID') }}<?php if(isset($page) && isset($campaign)) { echo '&campaign='.$campaign->getSlug(); } ?>&include-base=false'></script>
<?php } ?>