...
@section('scripts')
    {!! renderResourceTableScriptsDynamically(['url' => '/api/resources/content', 'DISPLAY_FORMAT' => 'cards', 'FILTERS' => "{type: 'post_type=$type->slug'}", "SORT_BY" => 'created_at',  "PER_PAGE" => 10, "LIMIT" => 1000]) !!}
@endsection